...
sudo apt install mcrypt php8.1 php8.1-mcrypt php8.1-mysql php8.1-sqlite3 php8.1-gd php8.1-common php8.1-dom php8.1-bcmath openssl php8.1-mbstring php8.1-curl php8.1-xml php8.1-zip php8.1-cli -y
